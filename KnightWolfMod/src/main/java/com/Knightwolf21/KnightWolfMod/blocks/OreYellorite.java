...
public class OreYellorite extends BlockBase
{
	public OreYellorite(String name, Material material) 
	{
		super(name, material);
		
		setSoundType(SoundType.STONE); // How it sounds when you walk on it
		setHardness(20.0F);            // How hard it is to break
		setResistance(100000.0F);      // How resistance to explosions
		setHarvestLevel("pickaxe", 3); // What is use to break it and what level it takes
		setLightLevel(6.0F);           // How much light it gives off
