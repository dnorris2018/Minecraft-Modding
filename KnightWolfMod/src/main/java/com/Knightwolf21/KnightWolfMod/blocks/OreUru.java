...
public class OreUru extends BlockBase
{
	public OreUru(String name, Material material) 
	{
		super(name, material);
		
		setSoundType(SoundType.STONE); // How it sounds when you walk on it
		setHardness(20.0F);            // How hard it is to break
		setResistance(5000000.0F);     // How resistance to explosions
		setHarvestLevel("pickaxe", 3); // What is use to break it and what level it takes
		setLightLevel(10.0F);          // How much light it gives off
