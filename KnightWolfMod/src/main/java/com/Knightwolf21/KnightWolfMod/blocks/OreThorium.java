...
public class OreThorium extends BlockBase
{
	public OreThorium(String name, Material material) 
	{
		super(name, material);
		
		setSoundType(SoundType.STONE); // How it sounds when you walk on it
		setHardness(30.0F);            // How hard it is to break
		setResistance(500000.0F);      // How resistance to explosions
		setHarvestLevel("pickaxe", 3); // What is use to break it and what level it takes
		setLightLevel(7.0F);           // How much light it gives off
