...
public class OreMagnesium extends BlockBase
{
	public OreMagnesium(String name, Material material) 
	{
		super(name, material);
		
		setSoundType(SoundType.STONE); // How it sounds when you walk on it
		setHardness(15.0F);            // How hard it is to break
		setResistance(100.0F);         // How resistance to explosions
